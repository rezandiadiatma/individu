<?php
   ...
   $sql = "SELECT * FROM pengeluaran WHERE kategori = '$kategori' and jumlah = '$jumlah' and keterangan = '$keterangan'";
   $query = $db->query($sql);
   /*if($query->num_rows != 0) {
     ...
     if(!$jumlah) {
       ...
       $data = "INSERT INTO pengeluaran (id,kategori,jumlah,keterangan,date) VALUES (NULL,'$kategori','$jumlah','$keterangan',now())";
