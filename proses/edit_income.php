...
{	
	...
	// update user data
	$result = mysqli_query($db, "UPDATE pendapatan SET kategori='$kategori',jumlah='$jumlah',keterangan='$keterangan' WHERE id=$id");
	 if($result) {
...
$result = mysqli_query($db, "SELECT * FROM pendapatan WHERE id=$id");
...
<hr><br>
  <div class="form">
    <form class="register-form" method="post" action="edit_income.php">
