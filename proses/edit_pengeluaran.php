...
{	
	...
	// update user data
	$result = mysqli_query($db, "UPDATE kategori_pengeluaran SET kategori='$kategori' WHERE id=$id");
	 if($result) {
...
$result = mysqli_query($db, "SELECT * FROM kategori_pengeluaran WHERE id=$id");
...
<hr><br>
  <div class="form">
    <form class="register-form" method="post" action="edit_pengeluaran.php">
