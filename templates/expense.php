...
$result = mysqli_query($db, "SELECT * FROM pengeluaran ORDER BY id ASC");
...
<body>
  <div class="form">
    <form class="register-form" method="post" action="proses/tambah_expense.php">
  ...
  while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='proses/edit_expense.php?id=$user_data[id]'>Edit</a> | <a href='proses/delete_expense.php?id=$user_data[id]' onClick=\"return confirm('Apa anda yakin?')\">Delete</a></td></tr>";
    $no++; 
	}
    ?>
</table>
